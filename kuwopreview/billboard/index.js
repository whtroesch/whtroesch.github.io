...
if (reversed == null) { reversed = false; }
	...
	this.instance_4 = new lib.slide4();
	this.instance_4.setTransform(1,1);

	this.instance_5 = new lib.slide5();
	this.instance_5.setTransform(1,1);

	this.instance_6 = new lib.slide6();
	this.instance_6.setTransform(1,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},48).to({state:[{t:this.instance_3}]},44).to({state:[{t:this.instance_4}]},48).to({state:[{t:this.instance_5}]},44).to({state:[{t:this.instance_6}]},46).wait(45));
