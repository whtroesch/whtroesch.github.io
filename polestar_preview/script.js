...
//var jsonFeed = "https://cdn-willhaben.adverserve.net/motor_json/22049969.json";
var jsonFeed = "https://whtroesch.github.io/polestar_preview/cars.json"
...
function cropTitle(title) {
    if (title.length > 39) {
        title = title.substr(0, 38).trim() + "&hellip;";
    }
...
function dynamicResize() {
    ...
    // maximum
    if (availableHeight > 1800 && availableWidth > 900) {
